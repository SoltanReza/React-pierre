...
const ContactUsSection = () => {
    return (
      <div
        className={`${styles.container} container mb-5 pb-5 d-flex align-items-center `}
      >
        <Animate type="left" className={`${styles.img} z-index-1 `}></Animate>
        <Animate
          delay={0.35}
          type="right"
          className={`${styles.main} tx-light bg-primary py-5 `}
        >
          <div className="pe-xl-5 py-md-5">
            <div className="px-md-5 py-lg-5 p-3 my-lg-5 me-lg-5">
              ...
              <p className={`${styles.blog} mb-5 pb-md-5 small`}>
                ...
                dui. In malesuada enim in door euismod, id commodo mi
                consecture. Curabitur at ves.
              </p>
              <Link
                to="/"
