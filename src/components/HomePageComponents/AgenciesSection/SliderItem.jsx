...
const SliderItem = ({ url, title, address, city, onNext, onPrevious }) => {
    return (
      <div className={`${styles.root} bg-img`}>
        <Animate className="d-flex" type="backdrop">
          <div
            className={`container tx-primary d-flex align-items-center ${styles.main} justify-content-lg-end`}
          >
            <Animate
              delay={0.5}
              type="left"
              className={`card text-center w-100 mb-md-0 my-5 ${styles.card}`}
            >
              ...
              <div className="my-5 pb-3">
                ...
                <a
                  ...
                  href="mailto:contact@agency-lyon.com"
                >
                  contact@agency-lyon.com
                </a>
              </div>
